    ...
    <div className="App">
      <div>
        <div className="flex md:flex md:flex-grow flex-row justify-end space-x-1">
          <a href="#" className="py-4 px-2 text-teal-500 border-b-4 border-teal-300 font-semibold">Home</a>
          <a href="#" className="py-4 px-2 text-gray-500 font-semibold hover:text-teal-300 transition duration-300">Services</a>
          <a href="#" className="py-4 px-2 text-gray-500 font-semibold hover:text-teal-300 transition duration-300">About</a>
          <a href="#" className="py-4 px-2 text-gray-500 font-semibold hover:text-teal-300 transition duration-300">Contact Us</a>
        </div>
      </div>
